...
public class FancyToastUtils {
    ...
    public static void showSuccess(CharSequence message) {
        FancyToast.makeText(Utils.getApplication(), message, Toast.LENGTH_SHORT, FancyToast.SUCCESS, false).show();
    }
    ...
    public static void showSuccess(@StringRes int stringId) {
        FancyToast.makeText(Utils.getApplication(), Utils.getApplication().getResources().getString(stringId),
    ...
    public static void showSuccess(@StringRes int stringId, final Object... args) {
        String string = Utils.getApplication().getResources().getString(stringId, args);
        FancyToast.makeText(Utils.getApplication(), string, Toast.LENGTH_SHORT, FancyToast.SUCCESS, false).show();
    }
    ...
    public static void showSuccessLong(String message) {
        FancyToast.makeText(Utils.getApplication(), message, Toast.LENGTH_LONG, FancyToast.SUCCESS, false).show();
    }
    ...
    public static void showSuccessLong(@StringRes int stringId, final Object... args) {
        String string = Utils.getApplication().getResources().getString(stringId, args);
        FancyToast.makeText(Utils.getApplication(), string, Toast.LENGTH_LONG, FancyToast.SUCCESS, false).show();
    }
    ...
    public static void showWarning(String message) {
        FancyToast.makeText(Utils.getApplication(), message, Toast.LENGTH_SHORT, FancyToast.WARNING, false).show();
    }
    ...
    public static void showWarning(@StringRes int stringId, final Object... args) {
        String string = Utils.getApplication().getResources().getString(stringId, args);
        FancyToast.makeText(Utils.getApplication(), string, Toast.LENGTH_SHORT, FancyToast.WARNING, false).show();
    }
    ...
    public static void showWarningLong(String message) {
        FancyToast.makeText(Utils.getApplication(), message, Toast.LENGTH_LONG, FancyToast.WARNING, false).show();
    }
    ...
    public static void showWarningLong(final @StringRes int stringId, final Object... args) {
        String string = Utils.getApplication().getResources().getString(stringId, args);
        FancyToast.makeText(Utils.getApplication(), string, Toast.LENGTH_LONG, FancyToast.WARNING, false).show();
    }
    ...
    public static void showError(String message) {
        FancyToast.makeText(Utils.getApplication(), message, Toast.LENGTH_SHORT, FancyToast.ERROR, false).show();
    }
    ...
    public static void showError(@StringRes int stringId, final Object... args) {
        String string = Utils.getApplication().getResources().getString(stringId, args);
        FancyToast.makeText(Utils.getApplication(), string, Toast.LENGTH_SHORT, FancyToast.ERROR, false).show();
    }
    ...
    public static void showErrorLong(String message) {
        FancyToast.makeText(Utils.getApplication(), message, Toast.LENGTH_LONG, FancyToast.ERROR, false).show();
    }
    ...
    public static void showErrorLong(final @StringRes int stringId, final Object... args) {
        String string = Utils.getApplication().getResources().getString(stringId, args);
        FancyToast.makeText(Utils.getApplication(), string, Toast.LENGTH_LONG, FancyToast.ERROR, false).show();
    }
    ...
    public static void showInfo(String message) {
        FancyToast.makeText(Utils.getApplication(), message, Toast.LENGTH_SHORT, FancyToast.INFO, false).show();
    }
    ...
    public static void showInfo(@StringRes int stringId, final Object... args) {
        String string = Utils.getApplication().getResources().getString(stringId, args);
        FancyToast.makeText(Utils.getApplication(), string, Toast.LENGTH_SHORT, FancyToast.INFO, false).show();
    }
    ...
    public static void showInfoLong(String message) {
        FancyToast.makeText(Utils.getApplication(), message, Toast.LENGTH_LONG, FancyToast.INFO, false).show();
    }
    ...
    public static void showInfoLong(final @StringRes int stringId, final Object... args) {
        String string = Utils.getApplication().getResources().getString(stringId, args);
        FancyToast.makeText(Utils.getApplication(), string, Toast.LENGTH_LONG, FancyToast.INFO, false).show();
    }
    ...
    public static void showConfusing(String message) {
        FancyToast.makeText(Utils.getApplication(), message, Toast.LENGTH_SHORT, FancyToast.CONFUSING, false).show();
    }
    ...
    public static void showConfusing(@StringRes int stringId, final Object... args) {
        String string = Utils.getApplication().getResources().getString(stringId, args);
        FancyToast.makeText(Utils.getApplication(), string, Toast.LENGTH_SHORT, FancyToast.CONFUSING, false).show();
    }
    ...
    public static void showConfusingLong(String message) {
        FancyToast.makeText(Utils.getApplication(), message, Toast.LENGTH_LONG, FancyToast.CONFUSING, false).show();
    }
    ...
    public static void showConfusingLong(final @StringRes int stringId, final Object... args) {
        String string = Utils.getApplication().getResources().getString(stringId, args);
        FancyToast.makeText(Utils.getApplication(), string, Toast.LENGTH_LONG, FancyToast.CONFUSING, false).show();
    }
    ...
    public static void showDefault(String message) {
        FancyToast.makeText(Utils.getApplication(), message, Toast.LENGTH_SHORT, FancyToast.DEFAULT, false).show();
    }
    ...
    public static void showDefault(@StringRes int stringId, final Object... args) {
        String string = Utils.getApplication().getResources().getString(stringId, args);
        FancyToast.makeText(Utils.getApplication(), string, Toast.LENGTH_SHORT, FancyToast.DEFAULT, false).show();
    }
    ...
    public static void showDefaultLong(String message) {
        FancyToast.makeText(Utils.getApplication(), message, Toast.LENGTH_LONG, FancyToast.DEFAULT, false).show();
    }
    ...
    public static void showDefaultLong(final @StringRes int stringId, final Object... args) {
        String string = Utils.getApplication().getResources().getString(stringId, args);
        FancyToast.makeText(Utils.getApplication(), string, Toast.LENGTH_LONG, FancyToast.DEFAULT, false).show();
    }
}
